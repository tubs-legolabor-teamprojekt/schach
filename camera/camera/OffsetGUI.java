...
public class OffsetGUI extends JFrame implements MouseListener {
    ...
    /*
     * Es wird entweder der offset berechnet (also exakte koordinaten des
     * schachfelds) oder die Punkte fuer den Vektor uebergeben, welche fuer die
     * Winkelberechnung zustaendig sind
     * 
     * @param bu Bild, welches zur Bearbeitung uebergeben wird
     * 
     * @param im ImageLoaderinstanz, an welche berechneten Werte uebergeben
     * werden sollen
     * 
