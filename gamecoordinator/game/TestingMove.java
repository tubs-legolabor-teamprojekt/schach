...
public class TestingMove
{
    public static void main(String[] args) {
        ...
        // Zug erstellen
        Move move = new Move(Field.getFieldNumber("b3"),
                Field.getFieldNumber("c4"), true, true, false);
        ...
        // Zug erstellen
        Move move2 = new Move(Field.getFieldNumber("c7"),
                Field.getFieldNumber("d8"), true, true, false);
        ...
        Move move3 = new Move(Field.getFieldNumber("h8"),
                Field.getFieldNumber("g7"));
