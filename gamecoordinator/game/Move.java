...
public class Move {
     ...
     *            Schachmatt
     */
    public Move(int fieldFrom, int fieldTo, boolean captured, boolean check, boolean checkMate) {
    ...
    public String getMoveAsText() {
        ...
        if (this.isPawnPromotion())
            str += "und erreicht die Grundlinie des Gegners und wandelt sich in " + ChessfigureConstants.getFigureName( // Figurtyp
                                                                                                                        // =>
                                                                                                                        // Name
                    ChessfigureConstants.getFigureTypeFromLetter(this.pawnPromotedTo) // Kuerzel
                                                                                      // =>
                                                                                      // Figurtyp
                                                                                      // (byte)
                    );
    ...
    public String toString() {
        return "Move [fieldFrom=" + fieldFrom + ", fieldTo=" + fieldTo + ", figure=" + Field.getInstance().getFigureAt(this.getFieldFrom()) + ", captured="
                + captured + ", pawnPromotion=" + pawnPromotion + ", pawnPromotedTo=" + pawnPromotedTo + ", check=" + check + ", checkMate=" + checkMate
