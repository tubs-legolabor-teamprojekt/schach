...
public final class ChessfigureConstants
{
     ...
     * @return short-Wert der erzeugten Figur. TODO Fehlerhafte Eingaben
     *         abfangen
     */
    public static short makeFigureShort(int color, byte figureType,
     ...
     * 
     * @param figureType
     *            Zu pruefender byte-Wert
     * @return True: Gueltiger Figurtyp; False: Ungueltiger Figurtyp
     */
    public static boolean isValidFigureType(byte figureType) {
        return (figureType == PAWN || figureType == ROOK
                || figureType == KNIGHT || figureType == BISHOP
                || figureType == QUEEN || figureType == KING);
    }

    /**
     * Erstellt aus einem Short-Wert die dazugehoerige Figur. Da in der Figur
     * nicht die Position gespeichert wird, werden die Positionsinformationen
     * des Short-Werts ignoriert.
     * 
     * @param sh
     *            Short-Wert, der die zu erstellende Figur enthaelt
     * @return Ein Objekt der entsprechenden Subklasse von Figure (FigureKing,
     *         FigureQueen...)
     */
    public static Figure makeFigureFromShort(short sh) {
        ...
        default:
            // duerfte nie der Fall sein, da in
            // ExtractInformationFromBinary.getFigure
     ...
     * 
     * @param letter
     *            Zu pruefendes Kuerzel
     * @return True: Kuerzel gueltig; False: Nicht
     */
    public static boolean isValidFigureLetter(char letter) {
        return (letter == KING_LETTER || isValidPawnPromotionFigure(letter));
    }

    /**
     * Ueberprueft, ob ein char-Wert einer regelkonformen Bauer-Umwandlung
     * entspricht
     * 
     * @param letter
     *            Zu pruefendes Kuerzel
    ...
    public static boolean isValidPawnPromotionFigure(char letter) {
        return (letter == QUEEN_LETTER || letter == KNIGHT_LETTER
                || letter == BISHOP_LETTER || letter == ROOK_LETTER);
    }
}
