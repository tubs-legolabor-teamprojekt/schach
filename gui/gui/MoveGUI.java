...
/**
 * Klasse, die ein Fenster repr�sentiert, das angezeigt wird, wenn der 
...
public class MoveGUI extends JFrame implements ActionListener
{
	...
	/**
	 * Gibt die MoveGUI-Instanz zur�ck.
...
//		this.setAlwaysOnTop(true);
	...
	/**
	 * Getter f�r die booleansche Variable, ob eine kurze
	 * oder lange Rochade gew�hlt wurde.
	 * @return isKingsideCastling true oder false
	 */
	public boolean isKingsideCastling()
	{
		// true f�r kurze und false f�r lange Rochade
	...
	{
		// wenn man einfach einen normalen Zug ausw�hlen m�chte
		if (e.getActionCommand() == "button_ok_NM") {
			this.setVisible(false);
		}

		// man kann erst auf OK klicken, wenn man einen Radiobutton ausgew�hlt hat
		...
		// oder false gesetzt, je nach dem, ob der Radiobutton f�r die kurze Rochade ausgew�hlt 
		// wurde oder nicht
