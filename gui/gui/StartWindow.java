...
/**
 * Klasse, die das allererste Fenster repr�sentiert.
 * 
 * @author Tabea
 * 
 */
public class StartWindow extends JFrame implements ActionListener {
    ...
    private JPanel forIcon = new JPanel(), forText = new JPanel(), forName = new JPanel(), forButton = new JPanel();
    ...
    /**
     * Gibt die StartWindow-Instanz zur�ck.
     * 
    ...
    public void makeLayout() {
        ...
        // damit man mit Enter best�tigen kann
    ...
    /**
     * Methode, die pr�ft, ob der Benutzer etwas in das Textfeld geschrieben
    ...
    /**
     * Private Klasse, die entsprechend auf Vorg�nge im Textfeld reagiert.
     * 
     * @author Tabea
     * 
     */
