...
public class StAXWriter {
    ...
    /**
     * Methode, die das aktuelle Spiel bzw. dessen PGN-Format in eine .txt-Datei
     * abspeichert. Um die einzelnen Dateien zu unterscheiden wird ein
     * Zeitstempel mit in den Dateinamen gebaut.
     * 
    ...
    public boolean makeFile() {
        ...
        try {
            String text = Exporter.exportMovesToPGN("Teamprojekt", "Legolabor", sdf.format(new Date()), StartWindow.getInstance().getUsername(), "Legoroboter",
                    "result", GameCoordinator.getInstance(false).getAllMoves());
