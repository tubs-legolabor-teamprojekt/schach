...
public class Gui extends JFrame {
    ...
    private String[] columnNames_1 = { "a", "b", "c", "d", "e", "f", "g", "h" }, columnNames_2 = { "8" };
    private String[][] rowData_1 = { { "a", "b", "c", "d", "e", "f", "g", "h" } }, rowData_2 = { { "8" }, { "7" }, { "6" }, { "5" }, { "4" }, { "3" }, { "2" },
            { "1" } };
    private JTable table_bottom = new JTable(rowData_1, columnNames_1), table_left = new JTable(rowData_2, columnNames_2);

    private boolean queen = false, bishop = false, knight = false, rook = false;

    private boolean startPressed = false;

    /**
     * Privater Konstruktor, der nur ein neues Objekt erstellt und eine
     * Checkerboard-Instanz setzt.
     * 
     * @param title
     */
    private Gui() {
    ...
    public void startWindow() {
        ...
        // wenn hier reingegangen wird, muss vorher der StartButton gedr�ckt
        // worden
    ...
    /**
     * Methode, die das Layout f�r die Schachbrettbeschriftung am unteren Rand
     * des Feldes erzeugt.
     */
    ...
    /**
     * Methode, die das Layout f�r die Schachbretbeschriftung am linken Rand des
     * Feldes erzeugt.
     */
    public void makeTable_leftLayout() {
        // der Spalte wird ein neuer CellRenderer hinzugef�gt
    ...
    /**
     * Methode, die die Informationen �ber die getroffene Spielfigurenwahl des
     * Spielers enth�lt, wenn der Bauer ausgewechselt werden durfte.
     * 
     * @param queen
     * @param bishop
     * @param knight
     * @param rook
     */
    public void pawnPromotionInformation(boolean queen, boolean bishop, boolean knight, boolean rook) {
        this.queen = queen;
        this.bishop = bishop;
        this.knight = knight;
        this.rook = rook;
    ...
    /**
     * Methode, die ein Dialogfenster mit der �bergebenen Nachricht �ffnet.
     * 
     * @param message
    ...
    /**
     * Getter f�r das Checkerboard-Objekt.
     * 
    ...
    /**
     * Getter f�r die booleansche Variable, die angibt, ob der StartButton
     * gedr�ckt worden ist oder nicht.
     * 
     * @return Start wurde gedr�ckt oder nicht
     */
    ...
    /**
     * Setter f�r die Information, ob der StartButton geklickt wurde.
     * 
     * @param startPressed
     *            Start wurde gedr�ckt oder nicht
     */
