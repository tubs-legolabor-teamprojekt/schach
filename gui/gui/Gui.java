...
public class Gui extends JFrame
{
    ...
    public void startWindow() {
        ...
        // wenn hier reingegangen wird, muss vorher der StartButton gedrückt
        // worden sein, also Variable auf true setzen
    ...
    /**
     * Methode, die das Layout für die Schachbrettbeschriftung am unteren Rand
     * des Feldes erzeugt.
     */
    ...
    /**
     * Methode, die das Layout für die Schachbretbeschriftung am linken Rand des
     * Feldes erzeugt.
     */
    public void makeTable_leftLayout() {
        // der Spalte wird ein neuer CellRenderer hinzugefügt
        this.table_left.getColumnModel().getColumn(0)
                .setCellRenderer(new MyCellRenderer(false));
    ...
    /**
     * Getter für die booleansche Variable, die angibt, ob der StartButton
