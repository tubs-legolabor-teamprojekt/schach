...
/**
 * Klasse, die die ben�tigte Methode des MouseListeners implementiert.
 * @author Tabea
 *
 */
public class MyMouseListener extends MouseAdapter
{
	 ...
	 * und die Tabelle/das Schachfeld �bergeben bekommt.
	 * @param grid
	 */
	...
	public void mouseClicked(MouseEvent e)
	{
		...
		// es wird nur etwas gemacht, wenn man auch seinen Zug manuell eingeben soll 
		//und nicht mehr als zweimal geklickt hat
		if (Checkerboard.getInstance().isManualMove() && this.counter < 3) {
			...
			// wenn man beide Felder ausgew�hlt hat Abfrage, ob korrekt
