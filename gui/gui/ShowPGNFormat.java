...
public class ShowPGNFormat extends JFrame implements ActionListener {
    ...
    private JPanel forText = new JPanel(), forButton = new JPanel();
     ...
     * erstellt, den Titel setzt und alle n�tigen Fenstereinstellungen aufruft.
     */
    ...
    /**
     * Gibt die ShowPGNFormat-Instanz zur�ck.
     * 
    ...
    public void makeLayout() {
        ...
        this.text.setText(Exporter.exportMovesToPGN("Teamprojekt", "Legolabor", sdf.format(new Date()), StartWindow.getInstance().getUsername(), "Legoroboter",
                "1-0", GameCoordinator.getInstance(false).getAllMoves()));
